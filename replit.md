...
- **Unit 2**: 93 FCA regulation questions (20 on FCA strategic objectives/principles + 18 on systems/controls/training & competence + 22 on financial promotions/customer communications/business risk + 16 on mortgage regulation/consumer credit + 10 on money laundering + 7 on GDPR/pension regulations)
- **Scenario Questions**: 10 scenario case studies with 5 questions each (50 questions total) for scenario quiz mode
- **Total**: 512 questions across 10 topics. Questions are designed to test understanding with similar numerical options and specific textbook details.
